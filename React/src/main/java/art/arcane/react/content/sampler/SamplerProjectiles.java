...
public class SamplerProjectiles extends ReactCachedSampler {
  public static final String ID = "projectiles";

  public SamplerProjectiles() {
    super(ID, 2000);
  }
  ...
  public double onSample() {
    if (J.isFoliaThreading()) {
      ...
      return (double) EntityCensusTracker.projectiles();
    }

...
public class SamplerCropFastForward extends ReactCachedSampler {
  ...
  public double onSample() {
    FeatureCropFastForward feature = React.feature(FeatureCropFastForward.class);
    if (feature == null) {
      return 0D;
    }
    ...
    long advanced = feature.readAndResetBlocksAdvanced();
    long durationMs = Math.max(now - lastSampleMs, 1000L);
    lastSampleMs = now;
    avg.put(advanced / (durationMs * ONE_OVER_MS));

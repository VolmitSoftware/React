...
public class SamplerLazyGravitySkipped extends ReactCachedSampler {
  public static final String ID = "lazy-gravity-skipped";
  ...
  public SamplerLazyGravitySkipped() {
    super(ID, 1000);
  }
  ...
  public double onSample() {
    FeatureLazyGravity feature = React.feature(FeatureLazyGravity.class);
    if (feature == null) {
      return 0D;
    }
    ...
    long skipped = feature.readAndResetProjectedSkippedTicks();
    long now = M.ms();

...
public final class CommandMessages {
  ...
  public static final TextKey DISTANCE_INVALID = TextKey.of("command.runtime.distance.invalid", "<red>Distance must be <white>{range}</white>.</red>");
  public static final TextKey DISTANCE_UNAVAILABLE = TextKey.of("command.runtime.distance.unavailable", "<red>This server does not support setting the <white>{scope} {type}</white> distance.</red>");
  public static final TextKey DISTANCE_SET = TextKey.of("command.runtime.distance.set", "<green>Set <white>{scope} {target}</white> <aqua>{type}</aqua> distance to <white>{distance}</white>.</green>");
  public static final TextKey DISTANCE_SCHEDULE_FAILED = TextKey.of("command.runtime.distance.schedule_failed", "<red>The distance change could not be scheduled on the required server thread.</red>");
  public static final TextKey DISTANCE_FAILED = TextKey.of("command.runtime.distance.failed", "<red>Failed to set <white>{scope} {target}</white> <aqua>{type}</aqua> distance. Check the console for the full error.</red>");

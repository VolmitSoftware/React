...
public final class MapMessages {
  ...
  private static final Map<String, TextKey> SAMPLER_SUMMARIES = Map.ofEntries(
      ...
      samplerSummary("redstone-event-span", "Wall-clock span from the first to the latest redstone event callback in each tick."),
      samplerSummary("hopper", "Hopper transfer/update activity rate."),
      samplerSummary("hopper-event-span", "Wall-clock span from the first to the latest hopper transfer callback in each tick."),
      samplerSummary("fluid", "Fluid update activity rate."),
      samplerSummary("fluid-event-span", "Wall-clock span from the first to the latest fluid-flow callback in each tick."),
      samplerSummary("physics", "Physics update activity rate."),
      samplerSummary("physics-event-span", "Wall-clock span from the first to the latest block-physics callback in each tick."),
      ...
      samplerSummary("world-save-event-interval", "Elapsed time between successive world-save events for a world."),
  ...
  private static final Map<String, TextKey> SAMPLER_NAMES = Map.ofEntries(
      ...
      samplerName("fluid-event-span", "Fluid Event Span"),
      ...
      samplerName("hopper-event-span", "Hopper Event Span"),
      ...
      samplerName("physics-event-span", "Physics Event Span"),
      ...
      samplerName("redstone-event-span", "Redstone Event Span"),
      ...
      samplerName("world-save-event-interval", "World Save Event Interval"),

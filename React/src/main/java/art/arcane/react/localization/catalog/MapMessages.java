...
public final class MapMessages {
  ...
  private static final Map<String, TextKey> SAMPLER_SUMMARIES = Map.ofEntries(
      ...
      samplerSummary("adapt-timing-budget", "Estimated share of each tick spent in adaptation guard checks."),
      ...
      samplerSummary("holoui-builder-server", "Whether the web builder server is running; one means online."),
      samplerSummary("holoui-display-entities", "Packet-only display entities registered for holograms."),
      samplerSummary("holoui-menu-definitions", "Menu definitions loaded from configuration."),
      samplerSummary("holoui-menus", "Holographic menus currently open."),
      samplerSummary("holoui-packets", "Hologram packets sent to clients per second."),
      samplerSummary("holoui-preview-refresh", "Container preview inventory refresh operations per second."),
      samplerSummary("holoui-previews", "Container HUD previews currently rendered."),
      samplerSummary("holoui-sessions", "Players holding any HoloUi menu or preview state."),
      samplerSummary("holoui-spawns", "Display entity spawn and despawn churn per second."),
      samplerSummary("holoui-tick-ms", "Main-thread milliseconds spent per second in the session tick loop."),
      samplerSummary("holoui-visible-entities", "Display entities actually spawned to a client right now."),
  ...
  private static final Map<String, TextKey> SAMPLER_NAMES = Map.ofEntries(
      ...
      samplerName("holoui-builder-server", "HoloUi Builder Server"),
      samplerName("holoui-display-entities", "HoloUi Display Entities"),
      samplerName("holoui-menu-definitions", "HoloUi Menu Definitions"),
      samplerName("holoui-menus", "HoloUi Menus"),
      samplerName("holoui-packets", "HoloUi Packets"),
      samplerName("holoui-preview-refresh", "HoloUi Preview Refresh"),
      samplerName("holoui-previews", "HoloUi Previews"),
      samplerName("holoui-sessions", "HoloUi Sessions"),
      samplerName("holoui-spawns", "HoloUi Spawns"),
      samplerName("holoui-tick-ms", "HoloUi Tick Time"),
      samplerName("holoui-visible-entities", "HoloUi Visible Entities"),

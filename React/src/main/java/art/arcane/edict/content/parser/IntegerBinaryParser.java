...
/**
 * The IntegerBinaryParser is a parser that parses binary string representations
 * into integers. It implements the EdictParser interface and its generic type
 * is Integer.
 *
 * @see EdictParser
 */

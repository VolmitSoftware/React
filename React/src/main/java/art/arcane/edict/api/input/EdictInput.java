...
/**
 * The EdictInput interface represents an input provided to an Edict command in
 * the Edict command handling system. The input can hold multiple parsed values,
 * each with an associated level of confidence about its validity.
 * <br><br>
 * The interface provides methods to retrieve these parsed values either in
 * their entirety or with a minimum confidence level, and to convert the input
 * into a specified type, given a minimum confidence level.
 */
public interface EdictInput {
   ...
   * @return A list of all parsed values with at least the specified confidence
   * level.
   */
  ...
  /**
   * Attempts to convert the input into a specified type with a minimum
   * confidence level of LOW.
   *
   * @return An optional containing the converted input if successful, otherwise
   * an empty optional.
   */
  ...
  /**
   * Attempts to convert the input into a specified type, given a minimum
   * confidence level.
   *
   * @param minimumConfidence The minimum confidence level.
   * @return An optional containing the converted input if successful, otherwise

 ...
 * An EdictRequest is composed of a list of EdictInputs, and optionally a match
 * offset and a paired EdictEndpoint.
 *
 * @see EdictInput
 * @see EdictEndpoint
 */
...
public class EdictRequest {
  ...
  /**
   * Constructs a new EdictRequest from another EdictRequest. This is a copy
   * constructor.
   *
  ...
  /**
   * Tries to match the path of the provided EdictEndpoint to the inputs of this
   * EdictRequest.
   *

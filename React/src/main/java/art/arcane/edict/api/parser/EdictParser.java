...
/**
 * Functional interface that defines the contract for a parser in the Edict
 * command handling system.
 * <br><br>
 * An implementation of this interface is responsible for parsing a String into
 * an object of type T, and producing an {@link EdictValue} that encapsulates
 * both the parsed object and an associated confidence level. The interface
 * provides several default methods to conveniently produce EdictValue instances
...
public interface EdictParser<T> {
  /**
   * Parses a string into an object of type T, wrapped in an EdictValue. The
   * implementation is expected to derive the confidence level as part of the
   * parsing process.
   *
   * @param s the string to parse
   * @return an EdictValue encapsulating the parsed object and an associated
   * confidence level
   */
  ...
  /**
   * Creates an EdictValue for the given object with a specified confidence
   * level.
   *
   * @param value the object to be encapsulated in an EdictValue
   * @param c     the confidence level associated with the value
   * @return an EdictValue encapsulating the object with a specified confidence
   * level
   */
  ...
  /**
   * Creates an EdictValue for the given object with a confidence level of
   * HIGH.
   *
   * @param value the object to be encapsulated in an EdictValue
   ...
   *
   * @param value the object to be encapsulated in an EdictValue
   * @return an EdictValue encapsulating the object with an INVALID confidence
   * level
   */

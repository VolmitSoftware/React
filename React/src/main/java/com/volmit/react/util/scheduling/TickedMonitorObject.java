...
public abstract class TickedMonitorObject implements Ticked, Listener {
    ...
    public TickedMonitorObject() {
        this("null");
    }

    public TickedMonitorObject(String group, String tid) {
        this(group, tid, 1000);
    }

    public TickedMonitorObject(String group) {
        this(group, UUID.randomUUID().toString(), 1000);
    }

    public TickedMonitorObject(String group, long interval) {
        this(group, UUID.randomUUID().toString(), interval);
    }

    public TickedMonitorObject(String group, String tid, long interval) {
        this.tgroup = group;
        this.tid = tid;
        ...
        this.tstart = M.ms();
        React.instance.getMonitorTicker().register(this);
    ...
    public void unregister() {
        React.instance.getMonitorTicker().unregister(this);

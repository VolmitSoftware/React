...
The authoritative documentation begins with [`00 - Overview.md`](React/docs/00%20-%20Overview.md). Installation and configuration are covered in [`01 - Installation & Configuration.md`](React/docs/01%20-%20Installation%20%26%20Configuration.md), and the complete document index is maintained in [`React/AGENTS.md`](React/AGENTS.md).

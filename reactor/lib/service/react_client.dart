...
abstract interface class IHeatmapClient {
  ...
  Future<HeatmapGrid> heatmap(String id,
      {String? world, int? centerX, int? centerZ, int? radius});
}
...
abstract interface class IActionClient {
  ...
  Future<ActionTicket> executeAction(String id,
      {required Map<String, Object?> params, required bool confirm});
}
...
class ReactClient
  ...
  Future<List<HeatmapSummary>> heatmaps() async {
    ...
    return data
        .map((dynamic e) =>
            HeatmapSummary.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<ControlItem> setFeatureEnabled(String id, bool enabled) async {
    final Map<String, dynamic> data =
        await _putData('/features/$id', <String, Object?>{'enabled': enabled});
  ...
  Future<ControlItem> setFeatureConfig(
    ...
    final Map<String, dynamic> data =
        await _putData('/features/$id/config', knobs);
    return ControlItem.fromJson(data);
  }
  ...
  Future<ControlItem> setTweakEnabled(String id, bool enabled) async {
    final Map<String, dynamic> data =
        await _putData('/tweaks/$id', <String, Object?>{'enabled': enabled});
    return ControlItem.fromJson(data);
  }
  ...
  Future<ControlItem> setTweakConfig(
      String id, Map<String, Object?> knobs) async {
    final Map<String, dynamic> data =
        await _putData('/tweaks/$id/config', knobs);
    return ControlItem.fromJson(data);
  }
  ...
  Future<List<WorldSettings>> worlds() async {
    ...
    return data
        .map((dynamic e) =>
            WorldSettings.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<List<ActionDescriptor>> actions() async {
    ...
    return data
        .map((dynamic e) =>
            ActionDescriptor.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<ConfigTree> applyPreset(String name) async {
    final Map<String, dynamic> data =
        await _postData('/config/preset/$name', const <String, Object?>{});
    return ConfigTree.fromJson(data);
  }

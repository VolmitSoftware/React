...
void main() {
  group('ControlScope', () {
    ...
    test('updateShouldNotify returns true when client changes', () {
      ...
      final ControlScope s1 =
          ControlScope(client: c1, child: Component.fragment(const <Widget>[]));
      final ControlScope s2 =
          ControlScope(client: c2, child: Component.fragment(const <Widget>[]));
    ...
    test('updateShouldNotify returns false when client is same instance', () {
      ...
      final ControlScope s1 =
          ControlScope(client: c, child: Component.fragment(const <Widget>[]));
      final ControlScope s2 =
          ControlScope(client: c, child: Component.fragment(const <Widget>[]));

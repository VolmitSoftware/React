...
import 'package:reactor/screen/governors.dart';
...
void main() {
  ...
  group('GovernorsScreen sidebar', () {
    testServer(
      'ReactorShell with a server renders Governors sidebar item',
  ...
  group('GovernorDashboardView render', () {
    testServer(
      ...
      (ServerTester tester) async {
        tester.pumpComponent(_wrapView(GovernorDashboardView(
        ...
        expect(
          ...
          isTrue,
          reason: 'governor name Pathfinder Budget must appear in rendered HTML',
        );
        expect(
  ...
  group('GovernorsScreen no-connection', () {
    testServer(
      ...
      (ServerTester tester) async {
        tester.pumpComponent(_wrapScreen(
        ...
        expect(
          ...
          isTrue,
          reason:
              'incident score gauge must still render when client is null',
        );
      },
    );
  });

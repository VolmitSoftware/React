...
import 'package:reactor/screen/comparison.dart';
  ...
  group('ComparisonScreen', () {
    testServer(
      ...
      (ServerTester tester) async {
        ...
        tester.pumpComponent(_wrap(<FleetServerLive>[
    ...
    testServer(
      ...
      (ServerTester tester) async {
        ...
        expect(
          ...
          isTrue,
          reason: 'Server A (value 20) must appear before server B (value 10) in leaderboard',
        );
      },
    );
    ...
    testServer(
      'shows empty-state text when no server has the selected metric',
      (ServerTester tester) async {
        ...
        tester.pumpComponent(_wrap(<FleetServerLive>[
          _liveServer('c', 'C', snapshot: snapC),
        ]));

...
import 'package:reactor/widget/knob_editor.dart';
...
void main() {
  group('KnobEditor rendering', () {
    testServer(
      'bool knob renders label and doc text',
    ...
    testServer(
      'int knob renders label and value',
      (ServerTester tester) async {
        const Knob knob = Knob(
          key: 'max-stack',
          label: 'Max Stack',
    ...
    testServer(
      'double knob renders label and value',
      (ServerTester tester) async {
        const Knob knob = Knob(
          key: 'threshold',
          label: 'Threshold',
    ...
    testServer(
      'string knob renders label and value',
      (ServerTester tester) async {
        const Knob knob = Knob(
          key: 'mode-name',
          label: 'Mode Name',

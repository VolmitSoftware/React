...
void main() {
  group('EnvironmentInfo', () {
    ...
    test('sectionNames contains all four sections', () {
      ...
      expect(info.sectionNames, containsAll(<String>['cpu', 'memory', 'jvm', 'server']));
    });
    ...
    test('absent section accessor returns empty map without throwing', () {
      final EnvironmentInfo info = EnvironmentInfo.fromJson(<String, dynamic>{});
    ...
    test('toJson returns the sections map', () {
      ...
      expect(json.keys, containsAll(<String>['cpu', 'memory', 'jvm', 'server']));
    });
  });
}

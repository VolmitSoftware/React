...
public class TXT {
     ...
     * @param len the amount of repeats
     * @return the string
     */
     ...
     * Build a tag
     *
     * @param brace   the brace color
     * @param tag     the tag color
     * @param colon   the colon color
     ...
     * @param percent the progress of the line
     * @param l       the left text
     * @param f       the centered text
     * @param r       the right text
     * @return the line
     */

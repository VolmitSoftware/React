...
public class Chunks {
     ...
     * @param safe  if set to true, the chunk will not be unloaded if players are
     *              nearby
     ...
     * @param save   should these chunks be saved?
     * @param safe   should we ignore chunks with players nearby?

...
public class RayTrace {
     ...
     * onTrace(Location l)
     *
     * @param start       the starting location for this trace
     * @param direction   the direction this trace should go
     * @param maxDistance the max distance this trace can cover
     * @param step        the step. 1 for normal. 0.5 for twice as many hits, 2 for half
     *                    as many.
     */
     ...
     *
     * @param location the location hit
     */

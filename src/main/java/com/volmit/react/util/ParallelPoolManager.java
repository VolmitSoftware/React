...
public abstract class ParallelPoolManager {
    ...
    private final GList<ParallelThread> threads;
    private final int threadCount;
    private final Queue<Execution> squeue;
    private final ThreadInformation info;
    private final GMap<String, Average> spikeSuppressor = new GMap<String, Average>();
    private int next;
    private String key;

...
public class W {
     ...
     *
     * @param p   the player
     * @param mb  the material block
     * @param amt the amount they need at least
     ...
     *
     * @param world the async/sync world
     * @return the sync world
     */
     ...
     *
     * @param block the async/sync block
     ...
     *
     * @param location the async location
     ...
     * @param pots the potions collection
     ...
     *
     * @param from the location to fall from
     ...
     *
     * @param e     the entity
     * @param range the max range to check for. If this is less than 1, 1 will be used
     *              instead.
     * @param off   the offeset. For example, if this is set to 2, then you cannot be
     ...
     *
     * @param is    the entity
     * @param at    the entity that IS should be looking at to return true
     * @param range the max range to check
     * @param off   the max offset

...
public class P {
    public static boolean isWithinViewDistance(Player p, Chunk c) {
        int manhattan = (int) ((double) Bukkit.getViewDistance() * Config.CHUNK_DISTANCE);
     ...
     * @param radius the three dimensional area radius to search
     ...
     *
     * @param p          the player
     * @param yawShift   the shift yaw
     * @param pitchShift the shift pitch
     * @return the location
     */

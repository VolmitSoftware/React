...
public class Gate {
    ...
    private static final GMap<String, Integer> defaultSettings = new GMap<String, Integer>();
    private static final GSet<Chunk> refresh = new GSet<Chunk>();
    private static final GSet<Location> destroy = new GSet<Location>();
    private static final GList<C> crgb = new GList<C>();

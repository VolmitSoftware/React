...
public class Capability
{
	...
	public static final Capability CHUNK_RELIGHTING = new Capability(Lang.getString("react.capabilities.chunk-relighting"), Lang.getString("react.capabilities.fawe")).max(Protocol.R1_13_2); //$NON-NLS-1$ //$NON-NLS-2$

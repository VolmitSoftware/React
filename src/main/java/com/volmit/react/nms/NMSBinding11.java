...
public class NMSBinding11 extends NMSBinding {
    ...
    public void updateBlock(Block bfg) {
        ...
        net.minecraft.server.v1_11_R1.Block b = org.bukkit.craftbukkit.v1_11_R1.util.CraftMagicNumbers.getBlock(bfg);
        ...
        net.minecraft.server.v1_11_R1.World v = w.getHandle();

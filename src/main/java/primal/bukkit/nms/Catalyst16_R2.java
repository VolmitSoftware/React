...
public class Catalyst16_R2 extends CatalystPacketListener implements CatalystHost
{
    ...
    {
        AdvancementHolder16_R2 a = new AdvancementHolder16_R2(UUID.randomUUID().toString());
        a.withToast(true);
        a.withDescription("?");
        a.withFrame(type);

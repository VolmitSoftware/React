...
public class Catalyst16_R3 extends CatalystPacketListener implements CatalystHost
{
    ...
    {
        AdvancementHolder16_R3 a = new AdvancementHolder16_R3(UUID.randomUUID().toString());
        a.withToast(true);
        a.withDescription("?");
        a.withFrame(type);

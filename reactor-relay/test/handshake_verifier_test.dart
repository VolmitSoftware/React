...
void main() {
  group('HandshakeVerifier', () {
    ...
    test('verify returns true for correct nonce, pubKey, and signature',
        () async {
    ...
    test('issueNonce emits URL-safe base64 without padding or standard chars',
        () {
    ...
    test('CROSS-LANGUAGE VECTOR: verify accepts a fixed Java-compatible (nonce, pubKey, sig)',
        () async {
    ...
    test('CROSS-LANGUAGE VECTOR: fingerprint of fixed pubKey matches shared hex',
        () {
      const String vectorPubKeyBase64Url =
          'MCowBQYDK2VwAyEAA6EHv_POEL4dcN0Y50vAmWfk1jCbpQ1fHdyGZBJVMbg';
      ...
      expect(fingerprintOfBase64(vectorPubKeyBase64Url),

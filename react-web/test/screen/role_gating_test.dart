...
import 'package:react_web/widget/role_badge.dart';
...
void main() {
  group('OptimizationGridView role gating', () {
    testServer('readOnly:true emits data-disabled="true" on toggle', (
      ServerTester tester,
    ) async {
    ...
    testServer('readOnly:false does not emit data-disabled="true" on toggle', (
      ServerTester tester,
    ) async {
      tester.pumpComponent(
        _wrap(
    ...
    testServer(
      ...
      (ServerTester tester) async {
        ...
        expect(
          ...
          isTrue,
          reason:
              'viewer role must show Requires admin role tooltip for destructive action',
        );
        expect(
          res.body.contains('data-disabled="true"'),
          isTrue,
    ...
    testServer(
      ...
      (ServerTester tester) async {
        ...
        expect(
          ...
          isTrue,
          reason:
              'operator role must show Requires admin role tooltip for destructive action',
        );
      },
    );
  ...
  group('RoleBadge', () {
    testServer('viewer role renders Viewer badge text', (
      ServerTester tester,
    ) async {

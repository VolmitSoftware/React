...
void main() {
  group('MonotonicCounter', () {
    ...
    test('new instance resumes from stored value', () {
      final InMemoryFleetStorage storage = InMemoryFleetStorage();
      final MonotonicCounter first = MonotonicCounter(
        storage,
        clock: () => 1000,
      );
      first.next('a');
      ...
      final MonotonicCounter second = MonotonicCounter(storage, clock: () => 5);
    ...
    test('50 successive calls produce strictly increasing sequence', () {
      ...
      final List<int> values = List<int>.generate(50, (_) => counter.next('x'));

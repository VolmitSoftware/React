...
void main() {
  ...
  group('ReactClient.executeAction()', () {
    test(
      'POSTs to /api/v1/actions/{id}/execute with counter header and body',
      () async {
        final Map<String, dynamic> responseBody = <String, dynamic>{
          'data': <String, dynamic>{'ticketId': 'tk-9', 'status': 'queued'},
        };
    ...
    test('409 response throws ReactConflict with server message', () async {
      final Map<String, dynamic> body = <String, dynamic>{
        'error': <String, dynamic>{'message': 'confirm required'},
      };
    ...
    test('403 response throws ReactForbidden', () async {
      final Map<String, dynamic> body = <String, dynamic>{
        'error': <String, dynamic>{'message': 'missing op:execute scope'},
      };

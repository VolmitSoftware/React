...
void main() {
  ...
  group('ReactClient.logs()', () {
    test(
      'GETs /api/v1/logs with explicit limit and decodes string list',
      () async {
    ...
    test('throws ReactUnavailable when data is not a list', () async {
      final Map<String, dynamic> body = <String, dynamic>{'data': 'not-a-list'};
      ...
      await expectLater(client.logs(), throwsA(isA<ReactUnavailable>()));
    });
  });
}

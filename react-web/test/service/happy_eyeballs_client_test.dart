...
void main() {
  group('HappyEyeballsClient', () {
    ...
    test(
      '(2) direct throws ReactUnavailable, relay succeeds -> activePath==relay',
      () async {
    ...
    test(
      '(3) pin enforcement: direct serverId bad, relay matches -> relay chosen',
      () async {
    ...
    test(
      '(5) pinnedFingerprint null -> first success wins regardless of serverId',
      () async {
    ...
    test(
      '(6) metrics ReactUnavailable marks stale, re-probe picks direct when healthy',
      () async {
        final _FakeClient direct = _FakeClient(
          serverId: 'fp:direct',
          shouldThrow: true,

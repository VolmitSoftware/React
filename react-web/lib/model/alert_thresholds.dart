class AlertThresholds {
  ...
  factory AlertThresholds.fromJson(Map<String, dynamic> j) => AlertThresholds(
    ...
    msptWarn: j.containsKey('msptWarn')
        ? (j['msptWarn'] as num).toDouble()
        : 50.0,
    incidentScoreWarn: j.containsKey('incidentScoreWarn')
        ? (j['incidentScoreWarn'] as num).toDouble()
        : 50.0,
    gcPercentWarn: j.containsKey('gcPercentWarn')
        ? (j['gcPercentWarn'] as num).toDouble()
        : 15.0,
    pingP95Warn: j.containsKey('pingP95Warn')
        ? (j['pingP95Warn'] as num).toDouble()
        : 200.0,
    memoryPressureWarn: j.containsKey('memoryPressureWarn')
        ? (j['memoryPressureWarn'] as num).toDouble()
        : 90.0,
  );
